...
const contentTypes = [
  ...
  {
    to: "/admin/media?type=audio",
    icon: Headphones,
    label: "Audio Content",
    desc: "Guided sessions, meditations, and audio programs.",
    accent: "from-violet-500/15 to-violet-900/30",
    iconColor: "text-violet-400",
  },
  {
    to: "/admin/media?type=video",
    icon: Video,
    label: "Video Content",
    desc: "Video courses, lessons, and tutorial content.",
    accent: "from-orange-500/15 to-orange-900/30",
  ...
  },
  {
    ...
    icon: Image,
    label: "Media Library",
    desc: "Browse and manage all uploaded media assets.",
